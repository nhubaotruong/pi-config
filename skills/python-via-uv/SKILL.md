---
name: python-via-uv
description: Enforce Python execution through `uv` instead of direct interpreter calls. Use when the agent needs to run Python scripts, modules, one-liners, tools, test runners, or package commands in a workspace and should avoid invoking `python` or `python3` directly.
---
