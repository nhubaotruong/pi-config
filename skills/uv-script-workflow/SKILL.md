...
description: Create, run, and maintain standalone Python scripts through `uv` only. Use when the agent needs to make a new single-file Python script, update that script's dependencies, or explain how to manage a PEP 723 script without editing inline metadata manually.
---
